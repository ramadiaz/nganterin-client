    ...
    <>
      {isLoading ? (
        ...
        <div className="w-3/4 mx-auto">
          <div className="flex flex-row gap-4 bg-white text-neutral-700 rounded-xl shadow-xl shadow-neutral-500/50 my-14 pb-14 p-4">
            <div className="basis-2/5 p-4">
              <div>
                <h1 className="text-lg font-semibold">Your Order History</h1>
                <h4 className="text-sm">
                  Your Booking History provides a detailed overview of all your
                  past travel reservations, including hotel stays, for easy
